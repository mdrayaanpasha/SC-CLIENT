...
import trending from "../public/trending.webp";
        ...
        <p style={{color:"#676186",fontSize:"3vh", marginRight:"3vw"}}>Scroll &rarr;</p>
            ...
            <h3 style={{position:"absolute",right:"0",}}>Slide &#8594; </h3>
                {RandomData && RandomData.map(element => (
                   ...
                   <img className="thing" src={`https://api-sc-pgsn.onrender.com/public/img/${element["Product Category"]}/${element["Sub Category"]}/${element["Sku"]}/main.jpg`} alt={element["Title"]}onClick={e=>window.location.href=element["Redirect"]}></img>
