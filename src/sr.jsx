...
function Shoerack() {
    ...
    useEffect(() => {
        const sofaFetch = async () => {
            ...
            try {
                const data = { Sku: sku };
                const D = await axios.post("http://localhost:3000/SRget", data);
    ...
    const se = (sku)=>{
        ...
        window.location.href=`/shoerack?sku=${sku}`
    }
    const cart = async()=>{
                                ...
                                <div className="carousel-inner">
                                    {productImgs.map((ele, index) => (
                                        <div key={index} className={`carousel-item ${index === 0 ? "active" : ""}`}>
                                            <img
                                                src={`http://localhost:3000/public/img/SR/${mainProduct[0]["Sub Category"]}/${sku}/${ele}`}
        ...
        ele !== '0' ? (
            ...
            <div key={index}>
                <img 
                    ...
                    src={`http://localhost:3000/public/img/SR/${mainProduct[0]["Sub Category"]}/${ele.replace(" ","")}/main.jpg`} 
                    alt={ele} 
...
<hr />
    ...
    <div key={index} className="other-product" onClick={e=>se(ele.Sku)}>
        <img 
            src={`http://localhost:3000/public/img/SR/${ele["Sub Category"]}/${ele.Sku}/main.jpg`}
            alt={ele.Sku} 
        />
